...
fileWriter.prototype.seek_relative_start_byte_index = function (absolute_start, fileIndex, callback) {
	...
	// The piece overlap several files
...
fileWriter.prototype.seek_relative_end_byte_index = function (absolute_end, callback) {
...
fileWriter.prototype.handle_piece = function (callback) {
	...
	this.write_to_file('path', 0, 0, 100, function () {
		console.log('returned from writing');
