...
/*
* Reads bitfield received from peers and parses it to an array representation
*/
Peer.prototype.parse_bitfield = function (length) {
	...
	for (var i = 2; i < length + 1; i ++) {
		...
		bitsArray = bitsString.split(''); //converts to array
...
function encodeBitField () {
	...
	} console.log("Length of bitfield: " + encodedBitfield.length);
